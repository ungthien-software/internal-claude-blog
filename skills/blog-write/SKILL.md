...
3. Write the template below verbatim to `<slugified-topic>.md` in the current working directory using the Write tool.
4. Confirm to the user: "Created `<slugified-topic>.md`."
